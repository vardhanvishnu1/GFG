<h2><a href="https://www.geeksforgeeks.org/problems/pythagorean-triplet3018/1?_gl=1*2x80ac*_up*MQ..*_gs*MQ..&gclid=Cj0KCQiA2bTNBhDjARIsAK89wlEWhpLtZZgqXKPih-bWp3mO0-Oltv5NQENAWONhykW3U2AnuHW_hyEaAg83EALw_wcB&gbraid=0AAAAAC9yBkBCLd3uUeqELCyP9Fo54byqk">Pythagorean Triplet</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong>, return true if there is a <strong>triplet (a, b, c)</strong> from the array (where a, b, and c are on different indexes) that satisfies <strong>a<sup>2</sup>&nbsp;+ b<sup>2</sup>&nbsp;= c<sup>2</sup></strong>, otherwise return false.</span></p>

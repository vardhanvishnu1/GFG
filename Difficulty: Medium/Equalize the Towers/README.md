<h2><a href="https://www.geeksforgeeks.org/problems/equalize-the-towers2804/1?_gl=1*k9gsiz*_up*MQ..*_gs*MQ..&gclid=Cj0KCQiA7rDMBhCjARIsAGDBuEBGJhxxfvpSNoWdX0O2hwD9fGQNab0_c19IPd2VVLVRQwpGEsFPTBoaAo-HEALw_wcB&gbraid=0AAAAAC9yBkCLUM3ou4SAk9iVKS5gjcGEe">Equalize the Towers</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given an array <strong><code>heights[]</code></strong> representing the heights of towers and another array <strong><code>cost[]</code></strong> where each element represents the cost of modifying the <strong>height </strong>of respective tower. </span></p>
<ul>
...
<li><span style="font-size: 14pt;">Modifying the height of tower <strong>'i'</strong> by 1 unit (add or remove) costs <strong>cost[i]</strong>.</span></li>
</ul>
<p><span style="font-size: 14pt;">Return the <strong>minimum </strong>cost to equalize the heights of all the towers.</span></p>

<h2><a href="https://www.geeksforgeeks.org/problems/consecutive-1s-not-allowed1912/1?_gl=1*jmmt*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwhLPOBhBiEiwA8_wJHBKfAUjRVYy9i1j4M-B8GWzCb3FWoEf27TqILMEhuV_VOFqvlCyJhBoCYvEQAvD_BwE&gbraid=0AAAAAC9yBkC67m21O4CVoJ8FbvLqbyuvS">Consecutive 1's not allowed</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a positive integer <strong>n</strong>, count all possible <strong>distinct binary strings</strong> of length <strong>n</strong> such that there are <strong>no consecutive 1’s</strong>.</span></p>

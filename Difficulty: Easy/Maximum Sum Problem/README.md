<h2><a href="https://www.geeksforgeeks.org/problems/maximum-sum-problem2211/1?_gl=1*1qchdnw*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwlLDQBhDjARIsAPlIefGw8G6t3bgUfaLgVf8NV2VpUSu1yqyL-hVr-1wYsdCEcU9sEH80HacaArsaEALw_wcB&gbraid=0AAAAAC9yBkByFTAtDcEiBafFVsmOydFUG">Maximum Sum Problem</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p dir="ltr">Given a number&nbsp;<strong><strong>n, </strong></strong>find its maximum sum value with 3 recursive breaks described below.</p>
<ul>
